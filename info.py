...
API_ID = int(environ.get('API_ID', '29377465'))
API_HASH = environ.get('API_HASH', 'a2d54a669f2a0b5fa893b337b2b44f11')
...
USERNAME = environ.get('USERNAME', "https://t.me/GAGAN_MEHRA") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002276175126'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/Movies_villae')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002384171684').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://stream:P@cluster0.bphcq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'My_Tg_files')
#---------------------------------------------------------------
#---------------------------------------------------------------
#----------- There will be channel id add in all these ---------
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002480693049'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','0')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002480693049'))
auth_channel = environ.get('AUTH_CHANNEL', '-1001884412480')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1001753339051'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002384171684') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '0')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Punjabi_movies_villa') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
IS_VERIFY = is_enabled('IS_VERIFY', True)
#---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/MOVIES_VILLA_UPDATE/85")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/MOVIES_VILLA_UPDATE/85")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/MOVIES_VILLA_UPDATE/85")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "cb53f1c71a70078e83a887bbe1e6e27a519a55fa")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'modijiurl.com')
SHORTENER_API2 = environ.get("SHORTENER_API2", "cb53f1c71a70078e83a887bbe1e6e27a519a55fa")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'modijiurl.com')
SHORTENER_API3 = environ.get("SHORTENER_API3", "cb53f1c71a70078e83a887bbe1e6e27a519a55fa")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '50'))
