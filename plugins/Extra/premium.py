...
async def plan(client, message):
    ...
    await message.reply_photo(photo="https://graph.org/file/72763ab73f27d460137c4.jpg", caption=script.PREPLANS_TXT.format(message.from_user.mention), reply_markup=InlineKeyboardMarkup(btn))
